        ...
        namespace multiprecision {
            namespace detail {
                ...
                struct is_byte_container_imp {
                    ...
                    using container_value_type = typename std::remove_cv<
                        typename std::iterator_traits<typename C::const_iterator>::value_type>::type;
                    static constexpr const bool value =
                        nil::crypto3::multiprecision::detail::is_integral<container_value_type>::value &&
