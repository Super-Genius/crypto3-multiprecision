                ...
                struct has_generic_interconversion {
                    using type = typename std::conditional<
                        ...
                        typename std::conditional<
                            ...
                            typename std::conditional<number_category<T>::value == number_kind_integer ||
                            ...
                            typename std::conditional<
                                ...
                                typename std::conditional<number_category<T>::value == number_kind_rational ||
                                                              number_category<T>::value == number_kind_rational,
                                                          std::integral_constant<bool, true>,
                                                          std::integral_constant<bool, false>>::type,
                                typename std::conditional<number_category<T>::value == number_kind_floating_point,
                                                          std::integral_constant<bool, true>,
