                ...
                namespace detail {
                    ...
                    struct mpfr_float_imp<digits10, allocate_dynamic> {
                        ...
                        mpfr_float_imp& operator=(boost::ulong_long_type i) {
                            ...
                            unsigned shift = 0;
                            mpfr_t t;
                            mpfr_init2(t, (std::max)(static_cast<mpfr_prec_t>(
                                                         std::numeric_limits<boost::ulong_long_type>::digits),
                                                     static_cast<mpfr_prec_t>(mpfr_get_prec(m_data))));
                            ...
                            if (mpfr_zero_p(m_data)) {
                                ...
                                if (fixed && e != -1) {
                                    ...
                                    if (digits == 0) {
                                        ...
                                        mp_exp_t old_e = e;
                                        ps =
                                            mpfr_get_str(0, &e, 10, static_cast<std::size_t>(digits), m_data, GMP_RNDN);
                                        --e;    // To match with what our formatter expects.
                                        if (old_e > e) {
...
#pragma warning(disable : 4127)    // Conditional expression is constant
                    ...
                    struct mpfr_float_imp<digits10, allocate_stack> {
                        ...
                        mpfr_float_imp& operator=(boost::ulong_long_type i) {
                            boost::ulong_long_type mask =
                                ((((1uLL << (std::numeric_limits<unsigned long>::digits - 1)) - 1) << 1) | 1uL);
                            unsigned shift = 0;
                            mpfr_t t;
...
#pragma warning(pop)
                ...
                struct mpfr_float_backend : public detail::mpfr_float_imp<digits10, AllocationType> {
                    ...
                    mpfr_float_backend(const gmp_int& val) : detail::mpfr_float_imp<digits10, AllocationType>() {
                        mpfr_set_z(this->m_data, val.data(), GMP_RNDN);
                    }
                    mpfr_float_backend(const gmp_rational& val) : detail::mpfr_float_imp<digits10, AllocationType>() {
                        mpfr_set_q(this->m_data, val.data(), GMP_RNDN);
                    }
                    mpfr_float_backend(const mpfr_t val) : detail::mpfr_float_imp<digits10, AllocationType>() {
                        mpfr_set(this->m_data, val, GMP_RNDN);
                    }
                    mpfr_float_backend(const mpf_t val) : detail::mpfr_float_imp<digits10, AllocationType>() {
                        mpfr_set_f(this->m_data, val, GMP_RNDN);
                    }
                    mpfr_float_backend(const mpz_t val) : detail::mpfr_float_imp<digits10, AllocationType>() {
                        mpfr_set_z(this->m_data, val, GMP_RNDN);
                    }
                    mpfr_float_backend(const mpq_t val) : detail::mpfr_float_imp<digits10, AllocationType>() {
                ...
                struct mpfr_float_backend<0, allocate_dynamic> : public detail::mpfr_float_imp<0, allocate_dynamic> {
                    ...
                    mpfr_float_backend(const gmp_int& val) : detail::mpfr_float_imp<0, allocate_dynamic>() {
                        mpfr_set_z(this->m_data, val.data(), GMP_RNDN);
                    }
                    mpfr_float_backend(const gmp_rational& val) : detail::mpfr_float_imp<0, allocate_dynamic>() {
                        mpfr_set_q(this->m_data, val.data(), GMP_RNDN);
                    }
                ...
                inline void eval_add(mpfr_float_backend<digits10, AllocationType>& result, long i) {
                    if (i > 0)
                        ...
                        mpfr_sub_ui(result.data(), result.data(), nil::crypto3::multiprecision::detail::unsigned_abs(i),
                                    GMP_RNDN);
                }
                template<unsigned digits10, mpfr_allocation_type AllocationType>
                inline void eval_subtract(mpfr_float_backend<digits10, AllocationType>& result, long i) {
                    if (i > 0)
                        ...
                        mpfr_add_ui(result.data(), result.data(), nil::crypto3::multiprecision::detail::unsigned_abs(i),
                                    GMP_RNDN);
                }
                template<unsigned digits10, mpfr_allocation_type AllocationType>
                inline void eval_multiply(mpfr_float_backend<digits10, AllocationType>& result, long i) {
                    mpfr_mul_ui(result.data(), result.data(), nil::crypto3::multiprecision::detail::unsigned_abs(i),
                                GMP_RNDN);
                    if (i < 0)
                ...
                inline void eval_divide(mpfr_float_backend<digits10, AllocationType>& result, long i) {
                    mpfr_div_ui(result.data(), result.data(), nil::crypto3::multiprecision::detail::unsigned_abs(i),
                                GMP_RNDN);
                    if (i < 0)
                        mpfr_neg(result.data(), result.data(), GMP_RNDN);
                }
                ...
                inline void eval_add(mpfr_float_backend<D1, A1>& a, const mpfr_float_backend<D2, A2>& x, long y) {
                    if (y < 0)
                        mpfr_sub_ui(a.data(), x.data(), nil::crypto3::multiprecision::detail::unsigned_abs(y),
                                    GMP_RNDN);
                    else
                        mpfr_add_ui(a.data(), x.data(), y, GMP_RNDN);
                }
                ...
                inline void eval_add(mpfr_float_backend<D1, A1>& a, long x, const mpfr_float_backend<D2, A2>& y) {
                    if (x < 0) {
                        mpfr_ui_sub(a.data(), nil::crypto3::multiprecision::detail::unsigned_abs(x), y.data(),
                                    GMP_RNDN);
                ...
                inline void eval_subtract(mpfr_float_backend<D1, A1>& a, const mpfr_float_backend<D2, A2>& x, long y) {
                    if (y < 0)
                        mpfr_add_ui(a.data(), x.data(), nil::crypto3::multiprecision::detail::unsigned_abs(y),
                                    GMP_RNDN);
                    else
                        mpfr_sub_ui(a.data(), x.data(), y, GMP_RNDN);
                }
                ...
                inline void eval_subtract(mpfr_float_backend<D1, A1>& a, long x, const mpfr_float_backend<D2, A2>& y) {
                    if (x < 0) {
                        mpfr_add_ui(a.data(), y.data(), nil::crypto3::multiprecision::detail::unsigned_abs(x),
                                    GMP_RNDN);
                        mpfr_neg(a.data(), a.data(), GMP_RNDN);
                    } else
                        mpfr_ui_sub(a.data(), x, y.data(), GMP_RNDN);
                ...
                inline void eval_multiply(mpfr_float_backend<D1, A1>& a, const mpfr_float_backend<D2, A2>& x, long y) {
                    if (y < 0) {
                        mpfr_mul_ui(a.data(), x.data(), nil::crypto3::multiprecision::detail::unsigned_abs(y),
                                    GMP_RNDN);
                        a.negate();
                    } else
                        mpfr_mul_ui(a.data(), x.data(), y, GMP_RNDN);
                ...
                inline void eval_multiply(mpfr_float_backend<D1, A1>& a, long x, const mpfr_float_backend<D2, A2>& y) {
                    if (x < 0) {
                        mpfr_mul_ui(a.data(), y.data(), nil::crypto3::multiprecision::detail::unsigned_abs(x),
                                    GMP_RNDN);
                        mpfr_neg(a.data(), a.data(), GMP_RNDN);
                    } else
                        mpfr_mul_ui(a.data(), y.data(), x, GMP_RNDN);
                ...
                inline void eval_divide(mpfr_float_backend<D1, A1>& a, const mpfr_float_backend<D2, A2>& x, long y) {
                    if (y < 0) {
                        mpfr_div_ui(a.data(), x.data(), nil::crypto3::multiprecision::detail::unsigned_abs(y),
                                    GMP_RNDN);
                        a.negate();
                    } else
                        mpfr_div_ui(a.data(), x.data(), y, GMP_RNDN);
                ...
                inline void eval_divide(mpfr_float_backend<D1, A1>& a, long x, const mpfr_float_backend<D2, A2>& y) {
                    if (x < 0) {
                        mpfr_ui_div(a.data(), nil::crypto3::multiprecision::detail::unsigned_abs(x), y.data(),
                                    GMP_RNDN);
                        mpfr_neg(a.data(), a.data(), GMP_RNDN);
                    } else
                        mpfr_ui_div(a.data(), x, y.data(), GMP_RNDN);
                ...
                inline void eval_ldexp(mpfr_float_backend<Digits10, AllocateType>& result,
                                       const mpfr_float_backend<Digits10, AllocateType>& val, long e) {
                    if (e > 0)
                ...
                inline void eval_frexp(mpfr_float_backend<Digits10, AllocateType>& result,
                                       const mpfr_float_backend<Digits10, AllocateType>& val, int* e) {
                ...
                inline void eval_pow(mpfr_float_backend<Digits10, AllocateType>& result,
                    ...
                    if (mpfr_zero_p(b.data()) && mpfr_integer_p(e.data()) && (mpfr_signbit(e.data()) == 0) &&
                        mpfr_fits_ulong_p(e.data(), GMP_RNDN) && (mpfr_get_ui(e.data(), GMP_RNDN) & 1)) {
...
#undef BOOST_MP_ENABLE_IF_WORKAROUND
                ...
                template<unsigned Digits10, mpfr_allocation_type AllocateType>
                inline void eval_remainder(mpfr_float_backend<Digits10, AllocateType>& result,
                ...
                inline void eval_remquo(mpfr_float_backend<Digits10, AllocateType>& result,
                                        const mpfr_float_backend<Digits10, AllocateType>& a,
                                        const mpfr_float_backend<Digits10, AllocateType>& b, int* pi) {
                    long l;
                ...
                template<unsigned Digits10, mpfr_allocation_type AllocateType>
                inline void eval_multiply_add(mpfr_float_backend<Digits10, AllocateType>& result,
                                              const mpfr_float_backend<Digits10, AllocateType>& a,
                                              const mpfr_float_backend<Digits10, AllocateType>& b) {
                ...
                template<unsigned Digits10, mpfr_allocation_type AllocateType>
                inline void eval_multiply_subtract(mpfr_float_backend<Digits10, AllocateType>& result,
                                                   const mpfr_float_backend<Digits10, AllocateType>& a,
                                                   const mpfr_float_backend<Digits10, AllocateType>& b) {
                ...
                template<unsigned Digits10, mpfr_allocation_type AllocateType>
                inline int eval_signbit
                    BOOST_PREVENT_MACRO_SUBSTITUTION(const mpfr_float_backend<Digits10, AllocateType>& arg) {
...
namespace boost {
    namespace math {
        ...
        namespace tools {
            ...
            inline void set_output_precision(const nil::crypto3::multiprecision::mpfr_float& val, std::ostream& os) {
...
#endif
            {
                return nil::crypto3::multiprecision::detail::digits10_2_2(
                    nil::crypto3::multiprecision::mpfr_float::default_precision());
            }
            template<>
            ...
            template<>
            inline nil::crypto3::multiprecision::mpfr_float max_value<nil::crypto3::multiprecision::mpfr_float>() {
                nil::crypto3::multiprecision::mpfr_float result(0.5);
            ...
            template<>
            inline nil::crypto3::multiprecision::mpfr_float min_value<nil::crypto3::multiprecision::mpfr_float>() {
                nil::crypto3::multiprecision::mpfr_float result(0.5);
            ...
            template<>
            inline nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::mpfr_float_backend<0>,
                                                        nil::crypto3::multiprecision::et_off>
                max_value<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::mpfr_float_backend<0>,
                                                               nil::crypto3::multiprecision::et_off>>() {
                nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::mpfr_float_backend<0>,
                                                     nil::crypto3::multiprecision::et_off>
                    result(0.5);
                mpfr_mul_2exp(result.backend().data(), result.backend().data(), mpfr_get_emax(), GMP_RNDN);
                BOOST_ASSERT(mpfr_number_p(result.backend().data()));
            ...
            inline nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::mpfr_float_backend<0>,
                                                        nil::crypto3::multiprecision::et_off>
                min_value<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::mpfr_float_backend<0>,
                                                               nil::crypto3::multiprecision::et_off>>() {
                nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::mpfr_float_backend<0>,
                                                     nil::crypto3::multiprecision::et_off>
                    result(0.5);
...
#endif
            {
                return nil::crypto3::multiprecision::detail::digits10_2_2(
                    nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::debug_adaptor<
                        nil::crypto3::multiprecision::mpfr_float::backend_type>>::default_precision());
            }
            template<>
            inline int digits<nil::crypto3::multiprecision::number<
            ...
            inline nil::crypto3::multiprecision::number<
                ...
                max_value<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::debug_adaptor<
                    nil::crypto3::multiprecision::mpfr_float::backend_type>>>() {
                return max_value<nil::crypto3::multiprecision::mpfr_float>().backend();
            }
            ...
            inline nil::crypto3::multiprecision::number<
                ...
                min_value<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::debug_adaptor<
                    nil::crypto3::multiprecision::mpfr_float::backend_type>>>() {
                return min_value<nil::crypto3::multiprecision::mpfr_float>().backend();
            }
            ...
            inline nil::crypto3::multiprecision::number<
                ...
                asinh BOOST_PREVENT_MACRO_SUBSTITUTION(
                    const nil::crypto3::multiprecision::number<
                        nil::crypto3::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>&
                        arg) {
                nil::crypto3::multiprecision::detail::scoped_default_precision<number<
                    nil::crypto3::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>>
                    precision_guard(arg);
...
namespace boost {
    namespace math {
        ...
        inline nil::crypto3::multiprecision::number<
            ...
            asinh BOOST_PREVENT_MACRO_SUBSTITUTION(
                const nil::crypto3::multiprecision::number<
                    nil::crypto3::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>& arg,
                const Policy&) {
            nil::crypto3::multiprecision::detail::scoped_default_precision<nil::crypto3::multiprecision::number<
                nil::crypto3::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>>
                precision_guard(arg);
            ...
            if (mpfr_inf_p(result.backend().data()))
                return policies::raise_overflow_error<nil::crypto3::multiprecision::number<
                    nil::crypto3::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>>(
                    "asinh<%1%>(%1%)", 0, Policy());
            if (mpfr_nan_p(result.backend().data()))
                return policies::raise_evaluation_error("asinh<%1%>(%1%)", "Unknown error, result is a NaN", result,
                                                        Policy());
            return result;
        }
        template<unsigned Digits10, nil::crypto3::multiprecision::mpfr_allocation_type AllocateType,
        ...
        inline nil::crypto3::multiprecision::number<
            ...
            if (mpfr_inf_p(result.backend().data()))
                return policies::raise_overflow_error<nil::crypto3::multiprecision::number<
                    ...
                    "acosh<%1%>(%1%)", 0, Policy());
            if (mpfr_nan_p(result.backend().data()))
                return policies::raise_evaluation_error("acosh<%1%>(%1%)", "Unknown error, result is a NaN", result,
                                                        Policy());
            return result;
        }
        template<unsigned Digits10, nil::crypto3::multiprecision::mpfr_allocation_type AllocateType,
        ...
        inline nil::crypto3::multiprecision::number<
            ...
            if (mpfr_inf_p(result.backend().data()))
                return policies::raise_overflow_error<nil::crypto3::multiprecision::number<
                    ...
                    "atanh<%1%>(%1%)", 0, Policy());
            if (mpfr_nan_p(result.backend().data()))
                return policies::raise_evaluation_error("atanh<%1%>(%1%)", "Unknown error, result is a NaN", result,
                                                        Policy());
            return result;
        }
        template<unsigned Digits10, nil::crypto3::multiprecision::mpfr_allocation_type AllocateType,
        ...
        inline nil::crypto3::multiprecision::number<
            ...
            if (mpfr_inf_p(result.backend().data()))
                return policies::raise_overflow_error<nil::crypto3::multiprecision::number<
                    ...
                    "cbrt<%1%>(%1%)", 0, Policy());
            if (mpfr_nan_p(result.backend().data()))
                return policies::raise_evaluation_error("cbrt<%1%>(%1%)", "Unknown error, result is a NaN", result,
                                                        Policy());
            return result;
        }
        template<unsigned Digits10, nil::crypto3::multiprecision::mpfr_allocation_type AllocateType,
        ...
        inline nil::crypto3::multiprecision::number<
            ...
            if (mpfr_inf_p(result.backend().data()))
                return policies::raise_overflow_error<nil::crypto3::multiprecision::number<
                    ...
                    "erfc<%1%>(%1%)", 0, pol);
            if (mpfr_nan_p(result.backend().data()))
                return policies::raise_evaluation_error("erfc<%1%>(%1%)", "Unknown error, result is a NaN", result,
                                                        pol);
            return result;
        }
        template<unsigned Digits10, nil::crypto3::multiprecision::mpfr_allocation_type AllocateType,
        ...
        inline nil::crypto3::multiprecision::number<
            ...
            if (mpfr_inf_p(result.backend().data()))
                return policies::raise_overflow_error<nil::crypto3::multiprecision::number<
                    ...
                    "expm1<%1%>(%1%)", 0, pol);
            if (mpfr_nan_p(result.backend().data()))
                return policies::raise_evaluation_error("expm1<%1%>(%1%)", "Unknown error, result is a NaN", result,
                                                        pol);
            return result;
        }
        template<unsigned Digits10, nil::crypto3::multiprecision::mpfr_allocation_type AllocateType,
        ...
        inline nil::crypto3::multiprecision::number<
            ...
            if (arg > 0) {
                ...
                if (floor(arg) == arg)
                    return policies::raise_pole_error<nil::crypto3::multiprecision::number<
                        nil::crypto3::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>>(
                ...
                result = nil::crypto3::multiprecision::log(
                             boost::math::constants::pi<nil::crypto3::multiprecision::number<
                                 nil::crypto3::multiprecision::mpfr_float_backend<Digits10, AllocateType>,
                                 ExpressionTemplates>>()) -
                         lgamma(arg, 0, pol) - nil::crypto3::multiprecision::log(t);
                if (sign) {
                    nil::crypto3::multiprecision::number<
                        nil::crypto3::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>
                        phase = 1 - arg;
            ...
            if (mpfr_inf_p(result.backend().data()))
                return policies::raise_overflow_error<nil::crypto3::multiprecision::number<
                    ...
                    "lgamma<%1%>(%1%)", 0, pol);
            if (mpfr_nan_p(result.backend().data()))
                return policies::raise_evaluation_error("lgamma<%1%>(%1%)", "Unknown error, result is a NaN", result,
                                                        pol);
            return result;
        }
        template<unsigned Digits10, nil::crypto3::multiprecision::mpfr_allocation_type AllocateType,
        ...
        inline typename std::enable_if<
            ...
            if (mpfr_inf_p(result.backend().data()))
                return policies::raise_overflow_error<nil::crypto3::multiprecision::number<
                    ...
                    "tgamma<%1%>(%1%)", 0, pol);
            if (mpfr_nan_p(result.backend().data()))
                return policies::raise_evaluation_error("tgamma<%1%>(%1%)", "Unknown error, result is a NaN", result,
                                                        pol);
            return result;
        }
        template<unsigned Digits10, nil::crypto3::multiprecision::mpfr_allocation_type AllocateType,
        ...
        inline nil::crypto3::multiprecision::number<
            ...
            if (mpfr_inf_p(result.backend().data()))
                return (arg == -1 ? -1 : 1) *
                       policies::raise_overflow_error<nil::crypto3::multiprecision::number<
                           nil::crypto3::multiprecision::mpfr_float_backend<Digits10, AllocateType>,
                           ExpressionTemplates>>("log1p<%1%>(%1%)", 0, pol);
            if (mpfr_nan_p(result.backend().data()))
                return policies::raise_evaluation_error("log1p<%1%>(%1%)", "Unknown error, result is a NaN", result,
                                                        pol);
            return result;
        }
        template<unsigned Digits10, nil::crypto3::multiprecision::mpfr_allocation_type AllocateType,
        ...
        inline nil::crypto3::multiprecision::number<
            nil::crypto3::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>
            rsqrt BOOST_PREVENT_MACRO_SUBSTITUTION(
                const nil::crypto3::multiprecision::number<
                    nil::crypto3::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>& arg,
                const Policy& pol) {
            nil::crypto3::multiprecision::detail::scoped_default_precision<nil::crypto3::multiprecision::number<
            ...
            if (mpfr_inf_p(result.backend().data()))
                return policies::raise_overflow_error<nil::crypto3::multiprecision::number<
                    ...
                    "rsqrt<%1%>(%1%)", 0, pol);
            if (mpfr_nan_p(result.backend().data()))
                return policies::raise_evaluation_error("rsqrt<%1%>(%1%)", "Negative argument, result is a NaN", result,
                                                        pol);
            return result;
        }
        template<unsigned Digits10, nil::crypto3::multiprecision::mpfr_allocation_type AllocateType,
    ...
    public:
        ...
        static number_type epsilon() {
            ...
            if (!value.first) {
                value.first = true;
                value.second = 1;
                mpfr_div_2exp(value.second.backend().data(), value.second.backend().data(),
    ...
    public:
        ...
        static number_type epsilon() {
            ...
            mpfr_div_2exp(value.backend().data(), value.backend().data(),
                          nil::crypto3::multiprecision::detail::digits10_2_2(number_type::default_precision()) - 1,
                          GMP_RNDN);
            return value;
        }
        static number_type round_error() {
