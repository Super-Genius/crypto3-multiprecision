    ...
    namespace crypto3 {
        namespace multiprecision {
            ...
            namespace std_constexpr {
                ...
                inline BOOST_CXX14_CONSTEXPR OutputIterator copy(InputIterator first, InputIterator last,
...
#endif
                    {
                        ...
                        if constexpr (std::is_pointer<InputIterator>::value && std::is_pointer<OutputIterator>::value &&
