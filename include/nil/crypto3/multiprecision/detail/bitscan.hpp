    ...
    namespace crypto3 {
        namespace multiprecision {
            namespace detail {
                ...
                template<class Unsigned>
                inline BOOST_MP_CXX14_CONSTEXPR unsigned find_lsb(Unsigned mask,
                                                                  const std::integral_constant<int, 0>&) {
                    return find_lsb_default(mask);
                }

                template<class Unsigned>
                inline BOOST_MP_CXX14_CONSTEXPR unsigned find_msb(Unsigned mask,
                                                                  const std::integral_constant<int, 0>&) {
...
#pragma intrinsic(_BitScanForward64, _BitScanReverse64)
                ...
                BOOST_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR unsigned find_lsb(Unsigned mask) {
                    using ui_type = typename nil::crypto3::multiprecision::detail::make_unsigned<Unsigned>::type;
                    using tag_type = typename std::conditional<
                        sizeof(Unsigned) <= sizeof(unsigned long), std::integral_constant<int, 1>,
#ifdef _M_X64
                        typename std::conditional<sizeof(Unsigned) <= sizeof(__int64), std::integral_constant<int, 2>,
                ...
                BOOST_FORCEINLINE unsigned find_lsb(boost::ulong_long_type mask,
                ...
                BOOST_FORCEINLINE unsigned find_msb(boost::ulong_long_type mask,
                                                    std::integral_constant<int, 3> const&) {
                ...
                BOOST_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR unsigned find_lsb(Unsigned mask) {
                    using ui_type = typename nil::crypto3::multiprecision::detail::make_unsigned<Unsigned>::type;
                    using tag_type = typename std::conditional<
                        sizeof(Unsigned) <= sizeof(unsigned), std::integral_constant<int, 1>,
                        typename std::conditional<
                            sizeof(Unsigned) <= sizeof(unsigned long), std::integral_constant<int, 2>,
                            typename std::conditional<sizeof(Unsigned) <= sizeof(boost::ulong_long_type),
                ...
                BOOST_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR unsigned find_lsb(Unsigned mask) {
                    using ui_type = typename nil::crypto3::multiprecision::detail::make_unsigned<Unsigned>::type;
                    using tag_type =
                        typename std::conditional<sizeof(Unsigned) <= sizeof(unsigned), std::integral_constant<int, 1>,
                                                  std::integral_constant<int, 0>>::type;
#ifndef BOOST_MP_NO_CONSTEXPR_DETECTION
                    if (BOOST_MP_IS_CONST_EVALUATED(mask)) {
                        return find_lsb_default(mask);
