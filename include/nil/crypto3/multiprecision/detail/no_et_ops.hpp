...
namespace nil {
    namespace crypto3 {
        namespace multiprecision {
            ...
            //
            template<class B>
            BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR number<B, et_off> operator+(const number<B, et_off>& a,
                                                                                      const number<B, et_off>& b) {
            ...
            BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR
                typename std::enable_if<is_compatible_arithmetic_type<V, number<B, et_off>>::value,
                                        number<B, et_off>>::type
            ...
            BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR
                typename std::enable_if<is_compatible_arithmetic_type<V, number<B, et_off>>::value &&
                                            !is_equivalent_number_type<V, B>::value,
                                        number<B, et_off>>::type
            ...
            BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR
                typename std::enable_if<number_category<B>::value == number_kind_integer ||
                                        ...
                                        number<B, et_off>>::type
                operator%(const number<B, et_off>& a, const number<B, et_off>& b) {
                detail::scoped_default_precision<multiprecision::number<B, et_off>> precision_guard(a, b);
                number<B, et_off> result;
            ...
            BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR
                ...
                detail::check_shift_range(
                    b, std::integral_constant<bool, (sizeof(I) > sizeof(std::size_t))>(),
                    std::integral_constant<bool, nil::crypto3::multiprecision::detail::is_signed<I>::value>());
            ...
            //
            template<class B>
            BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR number<B, et_off> operator+(number<B, et_off>&& a,
                                                                                      const number<B, et_off>& b) {
                using default_ops::eval_add;
                detail::scoped_default_precision<multiprecision::number<B, et_off>> precision_guard(a, b);
            ...
            template<class B>
            BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR
                typename std::enable_if<is_signed_number<B>::value, number<B, et_off>>::type
                operator-(const number<B, et_off>& a, number<B, et_off>&& b) {
                using default_ops::eval_subtract;
                detail::scoped_default_precision<multiprecision::number<B, et_off>> precision_guard(a, b);
            ...
            BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR
                typename std::enable_if<number_category<B>::value == number_kind_integer ||
                                            number_category<B>::value == number_kind_modular,
                                        number<B, et_off>>::type
                operator%(number<B, et_off>&& a, const number<B, et_off>& b) {
                using default_ops::eval_modulus;
                detail::scoped_default_precision<multiprecision::number<B, et_off>> precision_guard(a, b);
            ...
            BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR
                typename std::enable_if<number_category<B>::value == number_kind_integer ||
                                            number_category<B>::value == number_kind_modular,
                                        number<B, et_off>>::type
                operator|(number<B, et_off>&& a, number<B, et_off>&& b) {
                using default_ops::eval_bitwise_or;
                eval_bitwise_or(a.backend(), b.backend());
                return static_cast<number<B, et_off>&&>(a);
            }
