            ...
            namespace backends {
                namespace detail {
                    ...
                    inline BOOST_MP_CXX14_CONSTEXPR A checked_add_imp(A a, A b,
                        ...
                        if (a > 0) {
                            if ((b > 0) && ((boost::integer_traits<A>::const_max - b) < a))
                                raise_add_overflow();
                        } else {
                            if ((b < 0) && ((boost::integer_traits<A>::const_min - b) > a))
                                raise_add_overflow();
                        }
                        return a + b;
                    }
                    ...
                    inline BOOST_MP_CXX14_CONSTEXPR A checked_add_imp(A a, A b,
                        ...
                        if ((boost::integer_traits<A>::const_max - b) < a)
                            raise_add_overflow();
                        return a + b;
                    }
                    template<class A>
                    inline BOOST_MP_CXX14_CONSTEXPR A checked_add(A a, A b,
                                                                  const std::integral_constant<int, checked>&) {
                        return checked_add_imp(a, b, std::integral_constant < bool,
                                               nil::crypto3::multiprecision::detail::is_signed<A>::value&&
                                                       nil::crypto3::multiprecision::detail::is_integral<A>::value >
                                                   ());
                    }
                    template<class A>
                    inline BOOST_MP_CXX14_CONSTEXPR A checked_add(A a, A b,
                    ...
                    template<class A>
                    inline BOOST_MP_CXX14_CONSTEXPR A checked_subtract_imp(A a, A b,
                                                                           const std::integral_constant<bool, true>&) {
                        if (a > 0) {
                            if ((b < 0) && ((boost::integer_traits<A>::const_max + b) < a))
                    ...
                    template<class A>
                    inline BOOST_MP_CXX14_CONSTEXPR A checked_subtract(A a, A b,
                                                                       const std::integral_constant<int, checked>&) {
                        return checked_subtract_imp(
                    ...
                    template<class A>
                    inline BOOST_MP_CXX14_CONSTEXPR A checked_multiply(A a, A b,
                                                                       const std::integral_constant<int, checked>&) {
                        BOOST_MP_USING_ABS
                        if (a && (boost::integer_traits<A>::const_max / abs(a) < abs(b)))
                            raise_mul_overflow();
                        return a * b;
                    }
                    template<class A>
                    ...
                    template<class A>
                    inline BOOST_MP_CXX14_CONSTEXPR A checked_divide(A a, A b,
                                                                     const std::integral_constant<int, checked>&) {
                        if (b == 0)
                            raise_div_overflow();
                        return a / b;
                    ...
                    template<class A>
                    inline BOOST_MP_CXX14_CONSTEXPR A checked_left_shift(A a, boost::ulong_long_type shift,
                                                                         const std::integral_constant<int, checked>&) {
                        if (a && shift) {
                    ...
                    template<class A>
                    inline BOOST_MP_CXX14_CONSTEXPR A checked_left_shift(
                        A a, boost::ulong_long_type shift, const std::integral_constant<int, unchecked>&) {
